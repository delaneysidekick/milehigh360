...
'      <h3>2023 Tee It Up For College Golf Tournament Registration</h3>' + 
'      <div class="field radio 15539200 required" >' + 
'<label for="15539200"><input id="15539200" name="registration-type" class="required" type="radio" value="310.000000" maxlength="255" data-short-name="Golfer Registration" data-ticket-quantity="1" data-registration-type-value="15535105" data-non-deductible-amount="185.000000"></input><span class="label">$310.00 - Golfer Registration: Registration Fee for Each Golfer</span></label>' + 
'</div>' + 
'<div class="field radio 62108673 required" >' + 
'<label for="62108673"><input id="62108673" name="registration-type" class="required" type="radio" value="1140.000000" maxlength="255" data-short-name="Foursome Registration" data-ticket-quantity="4" data-registration-type-value="62106626" data-non-deductible-amount="740.000000"></input><span class="label">$1,140.00 - Foursome Registration: Registration for Four Golfers</span></label>' + 
'</div>' + 
'<div class="field radio 62108672 required" >' + 
'<label for="62108672"><input id="62108672" name="registration-type" class="required" type="radio" value="1640.000000" maxlength="255" data-short-name="Foursome + Hole Sponsorship" data-ticket-quantity="4" data-registration-type-value="95781889" data-non-deductible-amount="740.000000"></input><span class="label">$1,640.00 - Foursome + Hole Sponsorship: Registration for Four Golfers and Sign at One Hole</span></label>' + 
'</div>' + 
...
'      <div class="field text CustomTransactionField_95775744" >' + 
'<label for="CustomTransactionField_95775744"><span class="label">Golfer #1 Name</span></label>' + 
'<input id="CustomTransactionField_95775744" name="CustomTransactionField_95775744" type="text" maxlength="255"></input>' + 
'</div>' + 
'<div class="field text CustomTransactionField_95776768" >' + 
'<label for="CustomTransactionField_95776768"><span class="label">Golfer #2 Name</span></label>' + 
'<input id="CustomTransactionField_95776768" name="CustomTransactionField_95776768" type="text" maxlength="255"></input>' + 
'</div>' + 
'<div class="field text CustomTransactionField_95777792" >' + 
'<label for="CustomTransactionField_95777792"><span class="label">Golfer #3 Name</span></label>' + 
'<input id="CustomTransactionField_95777792" name="CustomTransactionField_95777792" type="text" maxlength="255"></input>' + 
'</div>' + 
'<div class="field text CustomTransactionField_95778816" >' + 
'<label for="CustomTransactionField_95778816"><span class="label">Golfer #4 Name</span></label>' + 
'<input id="CustomTransactionField_95778816" name="CustomTransactionField_95778816" type="text" maxlength="255"></input>' + 
'</div>' + 
'' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha15536128"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml15536128 = '<div class=\'donation-success\'>' +
                                                       '  <h2>Thank You for Your Registration!</h2>' +
                                                       '  <p>Your registration for Mile High 360\u0026#39;s Tee It Up for College has been successfully processed. We look forward to seeing you there!</p>' + 
                                                        ...
                                                        '</div>';( function($) {if (!Bloomerang.useDonationId('15536128')) { 
                                    html15536128 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                                }if (jQuery('#bloomerangForm15536128').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html15536128 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm15536128').after(html15536128);
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml15536128);
...
<script type="text/javascript" id="bloomerangForm15536128"></script>
