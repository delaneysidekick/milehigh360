...
'      <h3>Mizuna Dinner Registration</h3>' + 
'      <div class="field radio 95739904 required" >' + 
'<label for="95739904"><input id="95739904" name="registration-type" class="required" type="radio" value="275.000000" maxlength="255" data-short-name="Mizuna Dinner Ticket" data-ticket-quantity="1" data-registration-type-value="95735809" data-non-deductible-amount="75.000000"></input><span class="label">$275.00 - Mizuna Dinner Ticket: Dinner and admission for one</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha95736832"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'' +  '';var successHtml95736832 = '<div class=\'donation-success\'>' +
                    ...
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html95736832 = '<p style="color: red">Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm95736832').after(html95736832);
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml95736832);
